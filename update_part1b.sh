...
echo
drush en -y content_migrate computed_field content_taxonomy content_taxonomy_migrate date email field_group ctools link references node_reference user_reference features admin_menu
echo
